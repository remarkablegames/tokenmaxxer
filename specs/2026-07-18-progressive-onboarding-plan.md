...
- Reveal dashboard systems progressively:
  ...
  - Prestige after securing the 10 million trophy, or whenever pending Prestige credits exist.
...
- Derive the current objective and visible dashboard systems from clicks, owned upgrades, lifetime tokens, trophies, record index, and pending Prestige credits.

...
export const TRANSMISSIONS: TransmissionDefinition[] = [
  ...
  {
    id: 'reveal-automation-fleet',
    sender: 'Finance',
    role: 'FINANCE',
    initials: 'FN',
    message: 'Automation Fleet procurement is now accepting requests.',
    priority: 60,
    unlock: { type: 'lifetime-tokens', value: 50 },
  },
  {
    id: 'reveal-ai-model',
    sender: 'IT Support',
    ...
    priority: 60,
    unlock: { type: 'lifetime-tokens', value: 100 },
  },
  {
    id: 'reveal-parallel-worktrees',
    sender: 'IT Support',
    role: 'INFRASTRUCTURE',
    initials: 'IT',
    message:
      'Concurrent workspace tools have been approved for limited deployment.',
    priority: 60,
    unlock: { type: 'lifetime-tokens', value: 1_000 },
  },
  {
    id: 'reveal-efficiency-lab',
    sender: 'Legal',
    role: 'LEGAL',
    initials: 'LG',
    message:
    ...
    priority: 60,
    unlock: { type: 'lifetime-tokens', value: 5_000 },
  },
  {
    id: 'reveal-agent-swarm',
    sender: 'Token Reactor',
    role: 'SYSTEM',
    initials: 'TR',
    message: 'Multi-agent orchestration has been cleared for production.',
    priority: 60,
    unlock: { type: 'lifetime-tokens', value: 100_000 },
  },
  {
    id: 'reveal-orbital-datacenter',
    sender: 'Finance',
    role: 'FINANCE',
    initials: 'FN',
    message: 'Off-world infrastructure proposals are now being reviewed.',
    priority: 60,
    unlock: { type: 'lifetime-tokens', value: 1_000_000 },
  },
  {
